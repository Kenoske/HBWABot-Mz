...
//info
global.owner = ['918731030752'] // I phone number in thlak rawh
global.ownernumber = '918731030752' // I phone number in thlak rawh
global.ownername = "𝐀𝐬𝐩𝐢𝐫𝐚𝐧𝐭" // I hming dah tel bawk la
global.location = "India, Mizoram, Aizawl" // I awmna hmun daha
global.botname = "𝐀𝐬𝐩𝐢𝐫𝐚𝐧𝐭 𝐛𝐨𝐭" // I bot hming tur dah la
global.ownerweb = "https://youtube.com/@Mr_Answer_Official"
global.themeemoji = '🤖'
global.creator = "918731030752@s.whatsapp.net" // @ symbol hmaa number hi i phone number in thlak rawh

global.ownerNumber = ["918731030752@s.whatsapp.net"]// @ symbol hmaa number hi i phone number in thlak rawh
global.prefa = ['','!','.','#','/']
global.sessionName = 'session'

// Sticker Pack Name
global.packname = "𝐀𝐬𝐩𝐢𝐫𝐚𝐧𝐭 𝐛𝐨𝐭"
global.author = "𝐀𝐬𝐩𝐢𝐫𝐚𝐧𝐭"
